...
run_scene() {
    ...
    ./dist/mitsuba -z ${scene_dir}/$1/scene_v0.6.xml -D useNee=false -D trainingSamples=$2 -D sampleCount=$3 -o ${scene_dir}/$1/$1_table3.exr > ${scene_dir}/$1/$1_table3.log
    echo -n $1\;
