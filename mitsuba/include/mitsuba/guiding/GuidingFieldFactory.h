...
public:
    ...
    template<typename TSampleRange> // same as fit() but calling m_distributionFactory.updateFit(), not m_distributionFactory.fit()
    void updateFit(TGuidingRegion& region, TSampleRange& samples) const
    {
        ...
        */
        ...
        avgFitDuration.incrementBase();
#endif
        // discribution factory is VMMFactory
